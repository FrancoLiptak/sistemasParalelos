...
Pudimos aumentar la eficiencia del programa dandole a el proceso maestro trabajo una vez que repartio todos los trabajos a los worker, reduciendo el desbalance de carga. Tambien usamos pasaje de mensaje asincronico con el maestro para que no se quede sin hacer nada mientras espera que un worker le pida trabajo, esto tambien aumento la eficiencia.
